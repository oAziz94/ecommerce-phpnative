...
if($_GET){
    if(isset($_GET['prod']) && is_numeric($_GET['prod'])) {
        $product = new Product;
        $product->setId($_GET['prod']);
        $productResult = $product->productDetails();
        if($productResult){
            $products = $productResult->fetch_object();
        } else {
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="product-details-img">
                            <img class="zoompro" src="assets/img/product-details/<?php echo $products->photo ?>" data-zoom-image="assets/img/product-details/<?php echo $products->photo ?>" alt="zoom"/>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="product-details-content">
                            ...
                            <div class="rating-review">
                                ...
                                <?php    
                                    for($i=0;$i<$products-> product_avg_rate;$i++){
                                        echo '<i class="ion-android-star-outline theme-star"></i>';
                                    }
                                    for($i=0;$i<5-($products-> product_avg_rate);$i++){
                                ...
                                <div class="pro-dec-review">
                                    <ul>
                                        <li><?php echo $products->product_count_reviews ?> reviews</li>
                                        <li> Add Your Reviews</li>
                                    </ul>
                                </div>
                            </div>
                            <span><?php echo $products->price ?> EGP</span>
                            <div class="in-stock">
                                <p>Available: <span><?php echo (($products->stock && $products->stock > 0)?'In Stock': 'Out Of Stock')?></span></p>
                            </div>
                ...
                <div class="description-review-wrapper">
                    ...
                    <div class="tab-content description-review-bottom">
                        ...
                        <div id="des-details3" class="tab-pane">
                            ...
                            <?php
                                $reviewsResult = $product->getReviewsFromProducts();
                                if($reviewsResult){
                            ...
                            <?php
                                    ...
                                    echo "<div class='row'><div class='col-12 text-center text-warning'> No Reviews Yet</div></div>";
                                }
                            ?>
                            </div>
